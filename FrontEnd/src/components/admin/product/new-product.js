...
const NewProduct = (props) => {
  ...
  const [imgUrl, setImgUrl] = useState(product.imgUrl ? product.imgUrl : "");
  const [inventory, setInventory] = useState(
    product.inventory ? product.inventory : ""
  );
  const [country, setCountry] = useState(
    product.feature.country ? product.feature.country : ""
  );
  const [area, setArea] = useState(
    product.feature.area ? product.feature.area : ""
  );
  const [color, setColor] = useState(
    product.feature.color ? product.feature.color : ""
  );
  const [sugar, setSugar] = useState(
    product.feature.sugar ? product.feature.sugar : ""
  );
  const [acidity, setAcidity] = useState(
    product.feature.acidity ? product.feature.acidity : ""
  );
  const [tannic, setTannic] = useState(
    product.feature.tannic ? product.feature.tannic : ""
  );
  const [body, setBody] = useState(
    product.feature.body ? product.feature.body : ""
  );
  const [alcoholDegree, setAlcoholDegree] = useState(
    product.feature.alcoholDegree ? product.feature.alcoholDegree : ""
  );
  const [info, setInfo] = useState(product.info ? product.info : "");
